...
import dao.UserDao;
import static user.UserDashboard.jLabel11;
...
public class Purchase extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Purchase ID", "Product ID", "Product Name", "Quantity", "Price (Rs)", "Total"
            }
        ) {
    ...
    private void purchaseTable() {
        //cat.getCategoriesValue(jTable1, ""); // can remove
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(model.getRowCount() > 0){
            ...
            String address = value[3]+","+value[4]; //can remove value [4[
            ...
            for(int i = 0; i<model.getRowCount(); i++){
                ...
                purchaseDao.insert(id, uid, uname, uphone, pid, pName, q, pri, tot, purchaseDate, address, null, "Pending");
